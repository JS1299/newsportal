...
@section('content')
    <div class="container">
            ...
            @auth
                @if ((auth()->user()->role == 0 || auth()->user()->role == 1 || auth()->user()->role == 2) && (auth()->user()->status !=1) )
                    <div class="comments1">
                    ...
                    @else
                        <h2 class="center alert-danger">Sorry, you cannot leave comments, because you are blocked</h2>
                @endif
            @endauth
            @guest
